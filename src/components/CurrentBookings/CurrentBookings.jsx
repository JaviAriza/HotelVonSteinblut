  ...
  return (
    <div className="mt-10 p-6 rounded-lg">
      ...
      <div className="flex items-center justify-center gap-6 mt-10 mb-10">
        <button onClick={prevImage} className="text-gray-400 text-2xl">
          &#8249;
        </button>
        <div className="relative w-80 h-60 bg-gray-700 overflow-hidden rounded-lg">
          <div className="w-full h-full transition-transform duration-500 transform" style={{ transform: `translateX(-${currentImage * 100}%)` }}>
