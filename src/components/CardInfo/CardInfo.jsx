    ...
    <div className="max-w-sm bg-[#5f5c5c] rounded-2xl shadow-lg overflow-hidden text-white relative font-[Triodion]">
      ...
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          <span className="bg-white text-black px-4 py-1 rounded-3xl text-xs">Wifi: {room.caracteristicas.wifi}</span>
          <span className="bg-white text-black px-4 py-1 rounded-3xl text-xs">Climatización: {room.caracteristicas.climatizacion}</span>
          <span className="bg-white text-black px-4 py-1 rounded-3xl text-xs">TV: {room.caracteristicas.tv}</span>
        </div>

  
        <div className="mt-6">
        <p className="text-lg font-semibold"> {room.precioNoche} €
        <p>EUR/Noche</p></p>
        </div>
      </div>
