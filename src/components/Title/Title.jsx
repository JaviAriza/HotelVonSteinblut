...
export default function Title(props) {
  return (
    <div className="bg-transparent text-white text-center py-6 absolute left-1/2 -translate-x-1/2 w-3/4 my-10">
      <div className="mt-2">
      ...
      <h1 className="text-5xl font-serif tracking-widest uppercase">
        {props.text}
      </h1>
      <div className="mt-2">
